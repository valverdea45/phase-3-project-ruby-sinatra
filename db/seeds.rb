...
ivysaur.pokemon_skills.create(name: "Tackle", description: "", power_points: rand(5..30))

ivysaur.pokemon_skills.create(name: "Vine Whip", description: "", power_points: rand(5..30))
